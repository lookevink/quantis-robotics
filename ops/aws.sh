...
case "${command}" in
  ...
  jepa-wm-control-worker-rebase-proposal)
    ...
    ;;
  jepa-wm-physical-shadow-canary|jepa-wm-physical-shadow-canary-v2|jepa-wm-physical-shadow-canary-v3|jepa-wm-physical-shadow-canary-v4|jepa-wm-physical-shadow-canary-v5)
