...
if [[ "${experiment_schema}" == "quantis.jepa_wm_physical_shadow_canary_experiment.v3" || "${experiment_schema}" == "quantis.jepa_wm_physical_shadow_canary_experiment.v4" || "${experiment_schema}" == "quantis.jepa_wm_physical_shadow_canary_experiment.v5" ]]; then
...
if [[ "${experiment_schema}" == "quantis.jepa_wm_physical_shadow_canary_experiment.v4" || "${experiment_schema}" == "quantis.jepa_wm_physical_shadow_canary_experiment.v5" ]]; then
  isaac_server_call \
