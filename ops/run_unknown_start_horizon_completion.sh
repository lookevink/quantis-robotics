...
run_id="unknown-start-e2e-v29-62605-grasp"
source_session="unknown-start-e2e-v28-62605-grasp-022"
...
[[ "$((maximum_actions + source_horizon_actions))" == "${global_maximum_actions}" ]] || {
  printf 'error: frozen V29 cumulative action allocation changed\n' >&2
  exit 1
}
phase="claim"
