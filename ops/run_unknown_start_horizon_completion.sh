...
run_id="unknown-start-e2e-v36-62605-grasp"
source_session="unknown-start-e2e-v35-62605-grasp-015"
...
[[ "$((maximum_actions + source_horizon_actions))" == "${global_maximum_actions}" ]] || {
  printf 'error: frozen V36 cumulative action allocation changed\n' >&2
  exit 1
}
phase="claim"
