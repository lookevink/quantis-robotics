...
run_id="unknown-start-e2e-v35-62605-grasp"
source_session="unknown-start-e2e-v34-62605-grasp-001"
...
[[ "$((maximum_actions + source_horizon_actions))" == "${global_maximum_actions}" ]] || {
  printf 'error: frozen V35 cumulative action allocation changed\n' >&2
  exit 1
}
phase="claim"
