...
run_id="unknown-start-e2e-v19-62605-grasp"
source_session="unknown-start-e2e-v18-62605-grasp-02"
...
module="jepa_wm.contact_grasp_rotation_resolution"
...
[[ "${status}" == "applied" && "${grasp_ready}" == "true" ]] || {
  printf 'error: rotation-resolved acquisition did not retain grasp\n' >&2
  false
}
