...
async def recover_unknown_start_candidate_rollback(
    ...
    """Finish one failed candidate rollback to its exact authenticated reset."""
    ...
    from sim.isaac_control_runtime import live_runtime_for
    from sim.isaac_demo_runtime import JointCommand, resume_live_simulation
